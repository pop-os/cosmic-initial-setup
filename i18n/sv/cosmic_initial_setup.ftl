...
create-account-page = Skapa ditt konto
    ...
    .user-name-note = Detta kommer att användas för att namnge din hemkatalog, och kan inte ändras.
...
appearance-page = Personifiera utseende
    .description = Du kan ytterligare anpassa kontrastfärger och utseendet av ditt skrivbord i Utseende-inställningarna.
